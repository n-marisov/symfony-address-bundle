...
use Maris\Symfony\Address\Entity\Component;
...
class ComponentRepository extends ServiceEntityRepository
{
     ...
     * @return void
     */
    public function save( Component &$component , bool $flush = false ):void
    {

        $entity = $this->findOneBy([
            "value" => $component->getValue(),
            "type" => $component->getType(),
            "fullType" => $component->getFullType()
        ]);
    ...
    public function remove( Component $location , bool $flush = false ):void
    {
